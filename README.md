...
Offrir aux étudiants une **version démonstrative** des supports pédagogiques utilisés pour réussir le concours de médecine au Maroc.

## 📚 Contenu par matière

Chaque dossier contient :

- Des extraits du manuel
- Des exercices ou QCM
- Parfois des corrections ou explications selon la matière

## 🔗 Accès au Manuel Complet

Pour accéder au manuel complet, aux vidéos explicatives et à la plateforme d’entraînement :

👉 [Accéder au manuel Visa Médecine](https://medecine.visaconcours.ma)

---

**Visa Médecine – Préparez-vous efficacement, réussissez avec confiance.**
